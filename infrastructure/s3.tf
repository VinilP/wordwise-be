# S3 Bucket for static assets and book cover images
...
resource "aws_cloudfront_origin_access_control" "assets" {
  ...
  description                       = "OAC for ${local.name_prefix} assets bucket"
...
resource "aws_cloudfront_distribution" "assets" {
  ...
  comment             = "${local.name_prefix} assets distribution"
  ...
  tags = merge(local.common_tags, {
    Name = "${local.name_prefix}-assets-distribution"
  })
}